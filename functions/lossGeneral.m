function performance = lossGeneral(net,varargin)
% lossGeneral: Generalised performance function.
%
...
% Apply
performance = nncalc.perform(net,t,y,ew,param);