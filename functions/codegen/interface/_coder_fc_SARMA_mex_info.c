...
/* Include files */
#include "_coder_fc_SARMA_mex_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/LocalData/Documents/Documents/PhD/13_Software/05_Simulink/microGrid_MPC/minimise_max_power_drawn/models/commonFunctions/fc"
    "_SARMA_mex.m"), "context", 0);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 2);
  emlrtAddField(*info, b_emlrt_marshallOut(1395895856U), "fileTimeLo", 2);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/allOrAny.m"),
                "resolved", 3);
  emlrtAddField(*info, b_emlrt_marshallOut(1372554358U), "fileTimeLo", 3);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                "resolved", 4);
  emlrtAddField(*info, b_emlrt_marshallOut(1389681774U), "fileTimeLo", 4);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1286786358U), "fileTimeLo", 5);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m"),
                "resolved", 6);
  emlrtAddField(*info, b_emlrt_marshallOut(1286786386U), "fileTimeLo", 6);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/constNonSingletonDim.m"),
                "resolved", 7);
  emlrtAddField(*info, b_emlrt_marshallOut(1372554360U), "fileTimeLo", 7);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("fc_SARMA_mex"));
...
/* End of code generation (_coder_fc_SARMA_mex_info.c) */
